export const SIDE_PANEL_EASE: [number, number, number, number] = [0.32, 0.72, 0, 1];
export const SIDE_PANEL_WIDTH_DURATION = 0.4;
export const SIDE_PANEL_SLIDE_DURATION = 0.6;
