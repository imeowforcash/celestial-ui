...
export interface AppStuff {
  ...
  splitViewPrimaryFile?: string | null;
  splitViewOtherFile?: string | null;
  [key: string]: unknown;
}
...
const defaultThemes = ["Generic", "Blindness", "Dark Grape", "Ugly Green", "Evil and Gay", "Soft Twink", "Catppuccin Mocha", "Cheetos and Cream", "Cold Night"];
...
async function readDefaults(): Promise<AppSettings> {
  ...
  return { ...fallbackDefaults, ...defaultsFromFile };
}
